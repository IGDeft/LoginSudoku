...
public class InterfaceGrafica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        NivelJogo.setEditable(false);
        NivelJogo.setText("Níveis de jogo");
        NivelJogo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        NivelJogo.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        NivelJogo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NivelJogoActionPerformed(evt);
            }
        });

        NovoJogo.setText("Começar novo jogo");
        ...
        Pontuacao.setBackground(new java.awt.Color(255, 255, 255));
        ...
        Erros.setBackground(new java.awt.Color(255, 255, 255));
        Erros.setText("Erros:");
        ...
        GenioTempo.setEditable(false);
        GenioTempo.setBackground(new java.awt.Color(255, 255, 255));
        GenioTempo.setText("Contagem regressiva:");
        GenioTempo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GenioTempoActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(19, 19, 19))
                            .addComponent(NivelJogo, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(IniciarJogo, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(53, 53, 53)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(GenioTempo, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(44, 44, 44)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Pontuacao, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(Erros, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(NovoJogo, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Erros, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(NivelJogo, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(Facil)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Medio)
                        ...
                        .addGap(36, 36, 36)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(GenioTempo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void quadradoA1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA1MouseClicked
        ...
        try {
            ...
            if("".equals(quadradoA1.getText())){
                if(verificar(numero)){
                    verificarSolucao(0, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
                JOptionPane.showMessageDialog(null, "Quadrado ocupado");
            }
    ...
    private void quadradoA2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
           if("".equals(quadradoA2.getText())){
                if(verificar(numero)){
                    verificarSolucao(1, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA4.getText())){
                if(verificar(numero)){
                 verificarSolucao(3, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA3.getText())){
                if(verificar(numero)){
                    verificarSolucao(2, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA5.getText())){
                if(verificar(numero)){
                    verificarSolucao(4, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA6.getText())){
                if(verificar(numero)){
                    verificarSolucao(5, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA7.getText())){
                if(verificar(numero)){
                    verificarSolucao(6, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA8.getText())){
                if(verificar(numero)){
                    verificarSolucao(7, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoA9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoA9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoA9.getText())){
                if(verificar(numero)){
                    verificarSolucao(8, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB1.getText())){
                if(verificar(numero)){
                    verificarSolucao(9, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB2.getText())){
                if(verificar(numero)){
                    verificarSolucao(10, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB3.getText())){
                if(verificar(numero)){
                verificarSolucao(11, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB4.getText())){
                if(verificar(numero)){
                    verificarSolucao(12, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB5.getText())){
                if(verificar(numero)){
                    verificarSolucao(13, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB6.getText())){
                if(verificar(numero)){
                    verificarSolucao(14, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB7.getText())){
                if(verificar(numero)){
                    verificarSolucao(15, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB8.getText())){
                if(verificar(numero)){
                    verificarSolucao(16, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoB9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoB9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoB9.getText())){
                if(verificar(numero)){
                    verificarSolucao(17, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC1.getText())){
                if(verificar(numero)){
                    verificarSolucao(18, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC2.getText())){
                if(verificar(numero)){
                    verificarSolucao(19, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC3.getText())){
                if(verificar(numero)){
                    verificarSolucao(20, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC4.getText())){
                if(verificar(numero)){
                    verificarSolucao(21, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC5.getText())){
                if(verificar(numero)){
                    verificarSolucao(22, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC6.getText())){
                if(verificar(numero)){
                    verificarSolucao(23, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC7.getText())){
                if(verificar(numero)){
                    verificarSolucao(24, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC8.getText())){
                if(verificar(numero)){
                    verificarSolucao(25, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoC9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoC9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoC9.getText())){
                if(verificar(numero)){
                    verificarSolucao(26, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD1.getText())){
                if(verificar(numero)){
                    verificarSolucao(27, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD2.getText())){
                if(verificar(numero)){
                    verificarSolucao(28, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD3.getText())){
                if(verificar(numero)){
                    verificarSolucao(29, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD4.getText())){
                if(verificar(numero)){
                    verificarSolucao(30, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD5.getText())){
                if(verificar(numero)){
                    verificarSolucao(31, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD6.getText())){
                if(verificar(numero)){
                    verificarSolucao(32, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD7.getText())){
                if(verificar(numero)){
                    verificarSolucao(33, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD8.getText())){
                if(verificar(numero)){
                    verificarSolucao(34, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoD9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoD9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoD9.getText())){
                if(verificar(numero)){
                    verificarSolucao(35, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE1.getText())){
                if(verificar(numero)){
                    verificarSolucao(36, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE2.getText())){
                if(verificar(numero)){
                    verificarSolucao(37, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE3.getText())){
                if(verificar(numero)){
                    verificarSolucao(38, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE4.getText())){
                if(verificar(numero)){
                    verificarSolucao(39, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE5.getText())){
                if(verificar(numero)){
                    verificarSolucao(40, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE6.getText())){
                if(verificar(numero)){
                    verificarSolucao(41, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE7.getText())){
                if(verificar(numero)){
                    verificarSolucao(42, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE8.getText())){
                if(verificar(numero)){
                    verificarSolucao(43, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoE9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoE9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoE9.getText())){
                if(verificar(numero)){
                    verificarSolucao(44, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF1.getText())){
                if(verificar(numero)){
                    verificarSolucao(45, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF2.getText())){
                if(verificar(numero)){
                    verificarSolucao(46, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF3.getText())){
                if(verificar(numero)){
                    verificarSolucao(47, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF4.getText())){
                if(verificar(numero)){
                    verificarSolucao(48, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF5.getText())){
                if(verificar(numero)){
                    verificarSolucao(49, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF6.getText())){
                if(verificar(numero)){
                    verificarSolucao(50, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF7.getText())){
                if(verificar(numero)){
                    verificarSolucao(51, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF8.getText())){
                if(verificar(numero)){
                    verificarSolucao(52, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoF9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoF9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoF9.getText())){
                if(verificar(numero)){
                    verificarSolucao(53, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG1.getText())){
                if(verificar(numero)){
                    verificarSolucao(54, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG2.getText())){
                if(verificar(numero)){
                    verificarSolucao(55, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG3.getText())){
                if(verificar(numero)){
                    verificarSolucao(56, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG4.getText())){
                if(verificar(numero)){
                    verificarSolucao(57, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG5.getText())){
                if(verificar(numero)){
                    verificarSolucao(58, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG6.getText())){
                if(verificar(numero)){
                    verificarSolucao(59, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG8.getText())){
                if(verificar(numero)){
                    verificarSolucao(61, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG9.getText())){
                if(verificar(numero)){
                    verificarSolucao(62, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoG7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoG7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoG7.getText())){
                if(verificar(numero)){
                    verificarSolucao(60, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH1.getText())){
                if(verificar(numero)){
                    verificarSolucao(63, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH2.getText())){
                if(verificar(numero)){
                    verificarSolucao(64, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH3.getText())){
                if(verificar(numero)){
                    verificarSolucao(65, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH4.getText())){
                if(verificar(numero)){
                    verificarSolucao(66, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH5.getText())){
                if(verificar(numero)){
                    verificarSolucao(67, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH6.getText())){
                if(verificar(numero)){
                    verificarSolucao(68, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH7.getText())){
                if(verificar(numero)){
                    verificarSolucao(69, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH8.getText())){
                if(verificar(numero)){
                    verificarSolucao(70, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoH9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoH9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoH9.getText())){
                if(verificar(numero)){
                    verificarSolucao(71, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI1MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI1.getText())){
                if(verificar(numero)){
                    verificarSolucao(72, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI2MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI2.getText())){
                if(verificar(numero)){
                    verificarSolucao(73, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI3MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI3.getText())){
                if(verificar(numero)){
                    verificarSolucao(74, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI4MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI4.getText())){
                if(verificar(numero)){
                    verificarSolucao(75, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI5MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI5.getText())){
                if(verificar(numero)){
                    verificarSolucao(76, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI6MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI6.getText())){
                if(verificar(numero)){
                    verificarSolucao(77, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI7MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI7.getText())){
                if(verificar(numero)){
                    verificarSolucao(78, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI9MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI9.getText())){
                if(verificar(numero)){
                    verificarSolucao(80, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void quadradoI8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_quadradoI8MouseClicked
        ...
        try {
            int numero = Integer.parseInt(numeroString);
            if("".equals(quadradoI8.getText())){
                if(verificar(numero)){
                    verificarSolucao(79, numeroString);
                }else{
                JOptionPane.showMessageDialog(null, "Erro: Digite apenas numeros de 1 a 9");
                }
            }else{
    ...
    private void NivelJogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NivelJogoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NivelJogoActionPerformed
    ...
    private void IniciarJogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IniciarJogoMouseClicked
        ...
        //quadradosCorretos
        iniciarQuadradoCorretos(0,0,0);
        iniciarQuadradoCorretos(0,3,9);
        iniciarQuadradoCorretos(0,6,18);
        iniciarQuadradoCorretos(3,0,27);
        iniciarQuadradoCorretos(3,3,36);
        iniciarQuadradoCorretos(3,6,45);
        iniciarQuadradoCorretos(6,0,54);
        iniciarQuadradoCorretos(6,3,63);
        iniciarQuadradoCorretos(6,6,72);
        Facil.setVisible(false);
        Medio.setVisible(false);
        Dificil.setVisible(false);
        Genio.setVisible(false);
        IniciarJogo.setVisible(false);
        NivelJogo.setVisible(false);
        Dica.setVisible(true);
        if(tabuleiro.getNivel()==27){
            GenioTempo.setVisible(true);
            Cronometro.setForeground(Color.RED);
        }
        setTempoInicio(System.currentTimeMillis());
        //imprimirArray();
    ...
    private void DicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DicaMouseClicked
        ...
        int aux = 0;
        do{
            int indice = aleatorio.nextInt(0,81);        
            if(!quadrados.get(indice).getText().isEmpty()){
            } else {
                quadrados.get(indice).setText(this.numerosString.get(indice));
                ++aux;
            }
        }while(aux==0);
        if(jogoConcluido()){
    ...
    private void GenioTempoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenioTempoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_GenioTempoActionPerformed
    private boolean jogoConcluido(){
        for(int i = 0; i < this.quadrados.size(); i++){
            if(!quadrados.get(i).getText().isEmpty()){
            } else {
                return false;
            }
        }
    ...
    private void tempo(){
        ...
        long tempoTotal = tempoFim - getTempoInicio();
        Pontuacao pontuacao = new Pontuacao(tempoTotal); 
        int pontos = pontuacao.calcularPontuacao(tabuleiro.getNivel());
    ...
    private String cronometro(){
        if(tabuleiro.getNivel()==27){
            long tempoLimite = 5 * 60 * 1000;
            long tempoFim = System.currentTimeMillis();
            long tempoTotal = tempoFim - getTempoInicio();           
             if (tempoTotal < tempoLimite) {
                long tempoRestante = tempoLimite - tempoTotal;
                tempoRestante/=1000;
                if(tempoRestante > 60){
                    tempoRestante /= 60;
                    return tempoRestante + " minutos";
                }else{
                    return tempoRestante + " segundos";
                }                
             }else{
                 JOptionPane.showMessageDialog(null, "Perdeu: Acabou o tempo");
                 numeroUsuario.setText("Comece outro jogo");
                 numeroUsuario.setEditable(false);
                 Dica.setVisible(false);
                 return "00:00";
             }
        }else{
            long tempoFim = System.currentTimeMillis();
            long tempoReal = tempoFim - getTempoInicio();        
            tempoReal /= 1000;
            if(tempoReal > 60){
                tempoReal /= 60;
                return tempoReal + " minutos";
            }
            return tempoReal + " segundos";
        }
        
    }
    private void verificarSolucao(int indice, String numeroString){
        if(numeroString.equals(numerosString.get(indice))){
    ...
    private void imprimirArray(){
        for(int i = 0; i< numerosString.size(); i++){
            System.out.print(numerosString.get(i)+ " ");
            if(i==9 || i==18 || i==27 || i==36 || i ==45 || i == 54 || i==63 || i==72){
                System.out.println();
            }
        }
    }
    private void iniciarQuadradoCorretos(int lin, int col, int indice){
        int linQuadrado = lin - lin % 3;
        int colQuadrado = col - col % 3;
        int numero;
        for(int i = linQuadrado; i < linQuadrado + 3; i++){
            for(int j = colQuadrado; j < colQuadrado + 3; j++){
                numero = this.tabuleiro.getTabuleiro(i, j);
                String numeroString = Integer.toString(numero);                    
                this.numerosString.add(numeroString);
                indice++;
            }
        }
    }
